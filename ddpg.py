...
if __name__ == '__main__':
    ...
    env = gym.wrappers.RecordVideo(env, "videos/ddpg/LunarLanderv2",episode_trigger=lambda x: x % 10 == 0)

    writer = SummaryWriter("runs/ddpg/LunarLander-v2-Continuous")
