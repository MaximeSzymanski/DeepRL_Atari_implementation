...
class Agent():
    def __init__(self, env, memory_size, sample_size, gamma, epsilon, epsilon_decay, epsilon_min, lr,seed=0,
        ...
        self.memory = experience_replay(memory_size, sample_size,state_size=state_size)
        self.gamma = gamma
...
writer = SummaryWriter('runs/dqn/'+env_name)
...
agent = Agent(env, 10000, 256, 0.9999, 1.0, 0.996, 0.0, 0.0001,writer=writer)
...
#agent.play()
print("-"*50)
agent.train_agent(1000000, 32, 100, 'model.pth')
