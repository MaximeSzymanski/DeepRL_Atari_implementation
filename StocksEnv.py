...
class StockEnv(gym.Env):
    ...
    def __init__(self, window_size=90, company_ticker=None):
        ...
        self.observation_space = spaces.Box(low=-100, high=100, shape=(90,4,), dtype=np.float32)
        self.reward_list = []
    ...
    def reset(self, seed=None, options=None):
        ...
        print(f' Beginning for the stock {self.stock.ticker}')
...
print(np.array(first_state).shape)
